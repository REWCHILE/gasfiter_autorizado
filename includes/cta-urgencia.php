<!-- =========================================================================
     EMERGENCY CALL-TO-ACTION BANNER (Cinematic High-Impact Background)
     ========================================================================= -->
<section class="cta-emergency-strip" aria-label="Llamado a la acción de urgencias">
  <!-- Ambient Lighting & Technical Grid Overlay -->
  <div class="cta-bg-ambient-glow"></div>
  <div class="cta-bg-grid-pattern"></div>

  <div class="container cta-emergency-container">
    <!-- Live Status Pill -->
    <div class="cta-live-status-pill">
      <span class="cta-pulsing-dot"></span>
      <span>Técnicos de Guardia en Ruta • Respuesta Inmediata 24/7</span>
    </div>

    <!-- Main Title -->
    <h2 class="cta-emergency-title">
      ¿Olor a Gas, Fuga de Agua o Calefont Apagado?
    </h2>
    ...
    <div class="cta-emergency-buttons">
      <a href="tel:932237072" class="btn-cta-phone" aria-label="Llamar de inmediato al 9 3223 7072">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
        <span>Llamar al 9 3223 7072</span>
      </a>

      <a href="https://api.whatsapp.com/send?phone=56932237072&text=Hola%2C%20tengo%20una%20urgencia%20y%20necesito%20un%20Gasfiter%20Autorizado%20SEC%20a%20domicilio." class="btn-cta-whatsapp" target="_blank" rel="noopener noreferrer" aria-label="Contactar por WhatsApp">
