...
draw.text((50, 285), "• Sellado Prodoral R200 Sin Picar Pisos", font=font_subtitle, fill='#e2e8f0')
...
# Bottom details
draw.text((50, 535), "⚡ Llegada 30 a 45 min • Cobertura Santiago y Regiones", font=font_pill, fill='#94a3b8')
